            ...
            {
                {
                    0: (
                        ...
                        >
                            <DialogTitle
                                ...
                                sx={{ padding: '10px 10px 0 10px', margin: 0, backgroundColor: '#f2f6f8' }}
                            >
                            ...
                            <DialogActions sx={{ backgroundColor: '#f2f6f8', padding: '15px' }}>
                                <Stack flexDirection="row-reverse">
                                    <ThemeButton sx={{ padding: '5px 20px' }} onClick={handleAction}>
                                        Review Bid
                                    </ThemeButton>
                                </Stack>
                            </DialogActions>
                    ...
                    1: (
                        ...
                        >
                            ...
                            <DialogContent sx={{ padding: '20px 10px', margin: 0, width: '100%' }}>
                                <ReviewBid />
                            </DialogContent>
                            <DialogActions sx={{ backgroundColor: '#f2f6f8', padding: '15px' }}></DialogActions>
                        </Dialog>
                    )
                }[step]
            }
